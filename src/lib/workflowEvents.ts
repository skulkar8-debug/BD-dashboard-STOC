...
// Role label for the People grid
...
export const WORKFLOW_EVENTS: WorkflowEvent[] = [
  {
    ...
    wfSteps: 'WF01–08',
    phase: 'Research/Data',
    label: 'Data Prep & Research',
    bg: '#e0e7ff', border: '#6366f1', text: '#3730a3',
    sOff: -35, eOff: -22,
    owners: ['mrsupport'],          // Sharvan owns data pull / enrichment
  },
  {
    key: 'mrresearch',
    wfSteps: 'WF01–08',
    ...
    sOff: -35, eOff: -22,
    owners: ['mr'],                 // Srushti leads sector/sponsor research
  },
  {
    key: 'build',
    wfSteps: 'WF09–10',
    ...
    bg: '#c7d2fe', border: '#818cf8', text: '#3730a3',
    sOff: -21, eOff: -1,
    owners: ['mr'],                 // Srushti builds the report deck
  },
  {
    key: 'connect',
    wfSteps: 'WF11',
    ...
    sOff: -14, eOff: -7,
    owners: ['bd'],                 // BD connects with VPs/Principals
  },
  {
    key: 'connectsm',
    wfSteps: 'WF11',
    ...
    sOff: -14, eOff: -7,
    owners: ['sm'],                 // SM reminder-only for connections
  },
  {
    key: 'publish',
    wfSteps: 'WF12',
  ...
  },
  {
    ...
    phase: 'Outreach',
    label: 'Send Report',
    bg: '#99f6e4', border: '#0d9488', text: '#134e4a',
    sOff: 0, eOff: 1,
    owners: ['bd'],
  },
  {
  ...
  },
  {
    ...
    phase: 'TIP',
    label: 'Send TIP',
    bg: '#e9d5ff', border: '#a855f7', text: '#4c1d95',
    sOff: 5, eOff: 5,
    owners: ['bd', 'sm'],          // BD sends; SM gets reminder
  },
  {
    key: 'followup',
    wfSteps: 'WF16',
...
// Phase color bands for the legend
