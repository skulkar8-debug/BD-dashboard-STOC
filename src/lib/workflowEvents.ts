...
export const WORKFLOW_EVENTS: WorkflowEvent[] = [
  ...
  { key: 'connect',    wfSteps: 'WF11',    phase: 'Outreach',      label: 'LinkedIn Outreach',  bg: '#bfdbfe', border: '#3b82f6', text: '#1e3a8a', sOff: -14, eOff: -7,  owners: ['bd']         },
  { key: 'connectsm',  wfSteps: 'WF11',    phase: 'Outreach',      label: 'Connection Support', bg: '#ccfbf1', border: '#14b8a6', text: '#134e4a', sOff: -14, eOff: -7,  owners: ['sm']         },
